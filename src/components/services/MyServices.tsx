      ...
      <div className={styles["texts-container"]}>
        <div className={styles["text-inner-container"]}>
          ...
          <ul>
            ...
            <li>Individual Therapy for Perinatal Mood Disorders</li>
          ...
          <ul>
            {page === 1 ? (
              ...
              <>
                ...
                <li>
                  Perinatal Mood Disorders (Infertility issues, Post-Partum
              ...
              <>
                ...
                <li>
                  Psychosomatic disorders (emotional difficulties triggering
                  physical symptoms)
                </li>
                <li>Psychosis (schizophrenia, bipolar disorder)</li>
                <li>
                  Bi-cultural/minority individuals (psychological impact of
                  immigration)
                </li>
              </>
            )}
